...
```{r}
# Entfernen aller Datenpunkte außerhalb 2019 bis 2023
...
list_vendors = distinct(table_of_vendors, vendor, .keep_all = TRUE)
...
```{r}
# Filterung aller Produkte in Korea
all_products_in_kr = filter(transactions_2019_to_2023, region == "Skorea")
all_products_in_kr = select(products_in_kr, Product, region)
